...
//# BEGIN TODO Implement precondition checking
        if (! (getCount() > 0)) {
            throw new IllegalStateException(
                    "Statistics.getMinimum() violates precondition");
        }
        // @pre satisfied
//# END TODO
        return minimum;
...
//# BEGIN TODO Implement precondition checking
        if (! (getCount() > 0)) {
            throw new IllegalStateException(
                    "Statistics.getMaximum() violates precondition");
        }
        // @pre satisfied
//# END TODO
        return maximum;
...
//# BEGIN TODO Implement precondition checking
        if (! (getCount() > 0)) {
            throw new IllegalStateException(
                    "Statistics.getMean() violates precondition");
        }
        // @pre satisfied
//# END TODO
        return mean;
...
//# BEGIN TODO Implementation
        ...
        if (value > maximum) {
            maximum = value; // checking right bound
        }
        if (value < minimum) {
            minimum = value; // checking left bound
        }
        mean = ((mean * (count - 1)) + value) / count; // update mean
//# END TODO
    }
